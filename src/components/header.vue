<template>
  <header data-role="Header" class="header-header">
    <app-logo rootClassName="logo-root-class-name"></app-logo>
    ...
    <div data-role="MobileMenu" class="header-mobile-menu">
      <div class="header-nav1">
        <div class="header-container">
          ...
          <div data-role="CloseMobileMenu" class="header-close-mobile-menu">
      ...
      <div>
        <svg viewBox="0 0 950.8571428571428 1024" class="header-icon2">
          <path
          ...
          ></path></svg
        ><svg viewBox="0 0 877.7142857142857 1024" class="header-icon4">
          <path
          ...
          ></path></svg
        ><svg viewBox="0 0 602.2582857142856 1024" class="header-icon6">
          <path
